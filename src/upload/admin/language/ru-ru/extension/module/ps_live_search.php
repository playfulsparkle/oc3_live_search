...
$_['text_getting_started']                 = '<p><strong>Обзор:</strong> Playful Sparkle - Live Search — это расширение для OpenCart 3.x, предназначенное для динамического отображения результатов поиска в выпадающем списке по мере ввода пользователем. Оно поддерживает поиск по товарам, категориям, производителям и информационным страницам, с возможностью настройки размеров миниатюр, длины описаний и задержек для оптимального пользовательского опыта.</p><p><strong>Требования:</strong> OpenCart 3.x+, PHP 7.3</p>';
$_['text_setup']                           = '<ul><li><strong>Общие настройки:</strong> Настройте задержку ввода (по умолчанию: 100 мс), чтобы контролировать время между нажатиями клавиш и отображением результатов поиска.</li><li><strong>Настройки товаров:</strong><ul><li>Включить/Отключить результаты поиска по товарам.</li><li>Включить/Отключить отображение описаний товаров; установить максимальную длину описания (по умолчанию: 100 символов).</li><li>Включить/Отключить миниатюры товаров; установить ширину и высоту миниатюр (мин.: 16 px, макс.: 128 px).</li></ul></li><li><strong>Настройки категорий:</strong><ul><li>Включить/Отключить результаты поиска по категориям.</li><li>Включить/Отключить миниатюры категорий; установить размеры миниатюр (мин.: 16 px, макс.: 128 px).</li></ul></li><li><strong>Настройки производителей:</strong><ul><li>Включить/Отключить результаты поиска по производителям.</li><li>Включить/Отключить миниатюры производителей; установить размеры миниатюр (мин.: 16 px, макс.: 128 px).</li></ul></li><li><strong>Настройки информационных страниц:</strong><ul><li>Включить/Отключить результаты поиска по информационным страницам.</li></ul></li></ul>';
$_['text_troubleshot']                     = '<ul><li><strong>Live Search не работает:</strong> Обновите кэш модификаций, проверьте настройку задержки ввода и убедитесь, что модуль активирован.</li><li><strong>Отсутствуют конкретные результаты (товары, категории, производители, информация):</strong> Убедитесь, что соответствующая категория результатов включена в настройках.</li></ul>';
$_['text_faq']                             = '<details><summary>Какая стандартная задержка ввода?</summary> Стандартная задержка ввода установлена на 100 миллисекунд.</details><details><summary>Как установить максимальный размер миниатюры?</summary> Размеры миниатюр можно установить в диапазоне от 16 до 128 пикселей по ширине и высоте.</details><details><summary>Как ограничить длину описания товара?</summary> Длина описания может быть настроена в настройках; по умолчанию — 100 символов.</details><details><summary>Почему некоторые результаты не отображаются в выпадающем списке?</summary> Убедитесь, что конкретный тип результата (товар, категория, производитель или информация) включен в настройках модуля.</details>';
