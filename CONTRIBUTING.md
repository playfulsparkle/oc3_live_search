...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_live_search/issues) to avoid duplicates.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_live_search/issues)
